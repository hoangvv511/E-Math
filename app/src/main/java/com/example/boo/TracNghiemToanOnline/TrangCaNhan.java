    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDe1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                databaseRefence.child("Đề thi").child(ProfileActivity.username).child("Đề").child(name[1]).child("Câu hỏi").addChildEventListener(new ChildEventListener() {
                    @Override
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                        textViewLoad1.append(dataSnapshot.getValue().toString().trim() + "\n");
                    }
        ...
        btnDe2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                databaseRefence.child("Đề thi").child(ProfileActivity.username).child("Đề").child(name[2]).child("Câu hỏi").addChildEventListener(new ChildEventListener() {
                    @Override
                    public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                         textViewLoad2.append(dataSnapshot.getValue().toString().trim() + "\n");
                    }
